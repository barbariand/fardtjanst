...
struct CustomerInfo {
    ...
    pub hasReservationStatus: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct Departure {
    ...
    pub transportProvider: Option<Company>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transportProviderName: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct TripsRequest {
    ...
    // this is only returned and all above are optional in this struct for serilization and de serilisation
